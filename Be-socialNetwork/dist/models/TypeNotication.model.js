...
const TypeNoticationSchema = new mongoose_1.Schema({
...
const TypeNotication = mongoose_1.default.model(DOCUMENT_NAME, TypeNoticationSchema);
exports.default = TypeNotication;
