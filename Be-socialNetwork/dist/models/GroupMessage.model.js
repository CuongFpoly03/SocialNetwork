...
const GroupMessageSchema = new mongoose_1.Schema({
    ...
    groupMessage_group: { type: mongoose_1.default.Types.ObjectId, ref: 'Group', required: true },
...
const GroupMessage = mongoose_1.default.model(DOCUMENT_NAME, GroupMessageSchema);
